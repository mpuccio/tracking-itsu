...
const std::vector<std::pair<int, int>> CAIndexTableUtils::selectClusters(
    const std::array<int, CAConstants::IndexTable::ZBins * CAConstants::IndexTable::PhiBins + 1> &indexTable,
