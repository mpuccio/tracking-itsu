...
template<bool IsGPU>
struct CAPrimaryVertexContextInitializer final
{
...
template<bool IsGPU>
class CAPrimaryVertexContext final
{
  public:
...
template<bool IsGPU>
std::array<std::vector<int>, CAConstants::ITS::CellsPerRoad> CAPrimaryVertexContextInitializer<IsGPU>::initTrackletsLookupTable(const CAEvent &event)
{
...
template<bool IsGPU>
std::array<std::vector<CACell>, CAConstants::ITS::CellsPerRoad> CAPrimaryVertexContextInitializer<IsGPU>::initCells(const CAEvent &event)
{
